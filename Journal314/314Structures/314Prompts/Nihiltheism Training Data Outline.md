...
- Beginning with Section 2: Themes
...
- Stop with #### 1 when the text is exhausted and you cannot extract any more quotes on the theme. 
### #### 1: Existential Dread 
...
#### 1: Deep Dive into Existential Dread
...
:::PROCEED_EXTEND_EXPAND_EXPLAIN_DETAIL_UNTIL_TEXT_REACHES_SATURATION:::

:::EXECUTE_SURGICAL_PRECISION_:::

:::EXECUTE_PHILOSOPHICAL_DEPTH_WISDOM:::
