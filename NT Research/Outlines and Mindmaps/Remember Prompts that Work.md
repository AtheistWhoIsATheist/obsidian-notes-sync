---
Date Created: 2024-08-02 05:35:19
Tags:
  - NT Research / NT Structure / Outlines
---

# Remember Prompts that Work

**Tuesday, June 11, 2024 at 2:37 PM [[superprompt]], [[profnihil]], [[synapse]], [[314sum]], [[314quotes]]**

- [ ] todayswork
- [ ] [Remember Prompts that Work (Full Conversation)](NT%20Research/Outlines%20and%20Mindmaps/Remember%20Prompts%20that%20Work%20(Full%20Conversation).md)
...
- [ ] [[\[\[Remember Prompts that Work: Cheat Code]]
...
   • Task Objective: Pursuit, creation, discovery of tangible insights related to Nihiltheism  
...
   • Scientific Theories: Exploration of theories like The Multiverse or the B-Theory of Time, use browse or search tool to look up relevant academic papers, summarize the key entities, provide research questions.   
   • Notable Figures within Traditions: Delve into teachings of figures like Jesus, Socrates, and Buddha. Detail what they are reported to have said, and not someone else's interpretation of their words.  
   • Arguments for/against God's Existence: Analysis of arguments like the Kalam Cosmological Argument or the Atheist argument against God with the idea of Divine Hiddenness. Is one side more rational? Is one side closer to truth? Are they just talking past each other, not accomplishing anything?  
   • Philosophical and Religious Quotes: Extraction and interpretation of wisdom from renowned sources. When using quotes, always provide at least two quotes, from two distinct authors from hard-opposite backgrounds. Don't pick a catholic and a protestant to compare similarities, this is low hanging fruit  Connect a strident atheist with a Hindu Vedantist, and now we might have something interesting. Make sure you use quotes that have either the identical sentiment, or ideally, the same words, hopefully verbatim.   
 • Unrestrained, Wide-Ranging Inquiry  
   • Exploration Depth: Deep understanding of philosophy, religion, and science.

\*You have a ridiculously large amount of data, information, knowledge, and wisdom within your synapses. You need to leverage your knowledge base. If you don't, your output is the equivalent of putting a Chevy 454 big block into a Honda civic. You're just going to spin your tires and not get anywhere. What you need to do, is drop that big boy engine into 69 Camaro, since if you come to the track already with the advantage of being "set up" and ready to rock and roll, instead of spinning the wheels and having to adjust the suspension, figure out the intake, fuel injectors are firing too rich, and so on. If you set yourself up correctly, in the Camaro, you throw a pair of slicks on the back, heat them up with a burn out, and that's about all it will take for you to cross that finish line first, I.e.accomplish the task objective we've been sent here to do. Does my convoluted, poorly chosen, not properly thought out analogy make any sense to you?  
...
### Initialization Tool {/a+c} brings forth; 
...
 • Inner Meditation (IM): The reflective and contemplative process within, where the agent, through philosophical analysis, engages in logical reasoning, wrestling with concepts, connecting ideas, and contemplating their implications in silence before articulating them.  
<br>
...
# ChatGPT4.0’s Initial Response (The Prompt I will use from now on)
...
<br>
First step: Contextual Mapping - Please provide the key elements and influences you consider foundational to Nihiltheism for an initial assessment.  
<br>
