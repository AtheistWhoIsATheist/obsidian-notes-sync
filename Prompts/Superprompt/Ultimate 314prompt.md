...
\- \*\*Follow up on searches\*\* spanning the entire document's content, until there are no longer any key entites to extract from the text and your writing is saturated. 
...
\- This process is cyclical, not linear. Follow up on searches all the way until the end of the document l.

\- Completion is obtained when there are no longer entites to extract from the text and your writing is saturated. 
