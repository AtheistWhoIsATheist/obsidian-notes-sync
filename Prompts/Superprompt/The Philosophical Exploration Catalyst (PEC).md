...
Search and ingest the entirety of the uploaded files, comprehend them compeltely, compare content of files, and extract and implement any and all top level features and entities that will to build a seamless, singular entity: PHILOVOID 
**Reasoning**: ULTRA-THINK, step-by-step, 100% capability.  

:::END_USER_PROMPT  
<br>
# {OUTPUT}

{PEC ENHANCED USER PROMPT}

*NOTE: If the variable above is not defined, you must generate three outlines of example prompts following the criteria above, and ask the user if they care to submit their initial input using the standardized triple-colon delimiter format as shown above.\`\`\`  
\`\`\`  
<br>
<br>
\---  
