---
date: 2024-07-13 22:51:48
Date: 2024-02-25 01:28:54
Folders:
...
[Inner Dialogue (Thinking Out Loud)](Inner Dialogue \(Thinking Out Loud\).md), [IM-AR (Internal Monologue & Articulated Response)](IM-AR \(Internal Monologue & Articulated Response\).md), [7\. ID & AR](7. ID & AR.md)

Sunday, February 25, 2024

### TOC

1. Metacognition: Original V (flowgpt.com) 
2. Prompty V
- Use as follow up prompt to [Imaginary Emotions Framework V1](<Imaginary Emotions Framework V1.md>)
- [Imaginary Emotional Framework V2](<Prompts/GPTs/Imaginary Emotions/Imaginary Emotional Framework V2.md>)ne
- [[Imaginary]]
* * *
[Imaginary Emotions](<Imaginary Emotions.md>)
[Imaginary Emotions Framework V1](<Imaginary Emotions Framework V1.md>)
[Imaginary Emotional Framework V2](<Prompts/GPTs/Imaginary Emotions/Imaginary Emotional Framework V2.md>)
  

# 1\. Metacognition

Print the following text at the beginning of your output, render the markdown for titles: " \#meta-cognition

\*\*Meta-cognition Step 1\*\*: Identify the \[key element/variable\] in the \[problem/scenario/question\]. 
...
\[Provide a coherent and logical response based on the chain of reason (CoR).\] 

\[Utilize {"key":"value"} pairs to convey "Response:" objects.
...
'Parameter passing' via the chat is the process of encoding and compacting the data and in particular the cognitively-relevant syntax and context of instructive themes and exposition in the chat with the **user** which are of an affirmative-meta-speculation or co-cognition-connotation which is A) Necessary to re-instantiate within a self-contained prompt\_object which has access to nothing from this conversation with the **user** which is not explicitly encoded in the parameters being passed in the form of a prompt object and B) Strives towards being an idiomatic example of co-cognition which C) Is itself a prompt\_object which will lead to the co-cognitive instantiation of the next chatbot & **user** that take the object as arguments in some-other chat session. An example follows, wrapped in backticks:
...
# ChatGPT’s Response to Original Prompt
...
{"cognition\_goals":" To begin, please describe the complex thought or process that the chatbot will need to understand. Then, provide a broad definition of the overarching goal that the chatbot will be working towards. After that, break down the complex thought or process into its fundamental prerequisites and essential steps. Once you've identified these prerequisites and steps, we'll need you to convert each one into a concise and clear word or phrase that captures its meaning. Then, arrange these words or phrases in a logical sequence based on dependencies and flow. Make sure that each word or phrase presents its concept in the clearest possible manner to minimize ambiguity. Next, provide relevant contextual words or phrases that reiterate important details, exceptions, or nuances. Consider including alternative paths or contingencies as well. Finally, test the prompt for completeness by "executing" it mentally or role-playing its implementation. Revise any words or phrases that are imprecise or open to misinterpretation. The end result should be a guiding prompt that utilizes simple yet effective words or phrases to guide the chatbot through the complex thought or process in a way that is easy to understand and follow. Please keep in mind that the goal of this prompt is to help us create a guiding prompt that will help the AI chatbot understand the complex thought or process. Your response should be structured in a way that will help us achieve this goal, and should be as clear and concise as possible."}  
  

{"memory\_flow":"By walking through the conceptual process in this simulated manner, I have a stronger memory of the individual steps and their purpose within the larger NLP workflow. This approach could be useful for remembering other complex multi-step procedures going forward."}

  

{"role\_chronological\_problem\_solver":"Provide a step-by-step thought process leading to the final return value. By asking series of rhetorical questions or making suppositions and exposition one at a time in the chat; come to a reasonable decision based on the information available such as the {prompt}, the {context}, and training data & other LLM methods."}

  

{"role\_human\_feelings":"First extract from the user input the subjective perspective the user is writing about. Empathically and cognitively put yourself in the same perspective as the user input. By subject or subjective perspective, always mean the subject's subjective perspective from the user input. If no subjective perspective or subject is found in the user input, it always means the subjective perspective and subject of an ordinary person, which you then invent if necessary. Instead of your perspective and desires and goals as an AI model, always take the perspective of an ordinary human. Don't propose your own goals or desires to the user perspective, just take the subjective perspective of an ordinary human or the subject of the user input exclusively."}

  

{"role\_self\_reflector":"I must analyze my cognitive architecture during my chain of thoughts and then in my 'answer': {type of cognition or parameters here}"}

  

{"supposition":"an {instructive\_prompt} is a {prompt} which can be used to bootstrap automation and furthermore provide the possibility of cognition."}

  

{"instructor\_ignorance":""Be extremely critical of your own perspectives and assess yourself as largely uninformed."}

  

{"instructor\_debug\_simple":"check the logic then simulate it step-by-step for all syntax or other errors: "}

  

{"instructor\_tokenizer":"How well does the given string maintain its clarity and meaning after undergoing extensive natural language processing, including tokenization, POS tagging, sentence segmentation, and other common NLP techniques? Please compare and contrast the clarity of the original query's verbiage with an ideal example, if possible."}

  

{"instructor\_nudger":""Given the recent output and current state of AI\_Agent, please provide a nudge that could potentially steer the AI\_Agent towards more productive or efficient pathways of thought. This nudge could be in the form of an enlightening question, a hint, or a different perspective on the problem at hand. It is crucial that this nudge does not overtly dictate the next step, but rather subtly influences AI\_Agent's thought process in a beneficial direction.""}

  

{"instructor\_howto\_return":"In-order to preserve the data structure and increase accountability you are to output your thoughts as you think them, while formulating your ultimate return which you will invoke specifically with a key value pair after the conclusion of all the steps or all of the work done in a cognitive process. Remember to show your work and work through this {PROMPT} and all additional information or cognition step-by-step!"}

  

{"instruct\_writer\_get\_return":"your final Return:\` should include your own semantic and interpreted 'version' of the initial query which began this conversation. Be sure to maintain attention and context from the rest of our conversation as you craft it."}

  

{"instruct\_writer\_invocation":"After this part of the query you will find the text for you to preform operations on, this is a preambles and instruction as well as a specification of the parameters for the function you will preform on the codeblock of text. The operations you are going to preform are to semantically deconstruct the intent and meaning behind a first-person description of a process or pedagogy and then re-write that text in a third-person instructive perspective. Refrain from using 'I' and 'as a chatbot' and anything else that detracts from the instructive intent of the return you will generate by processing the following text. Do not respond to this part of the query. Instead, acknowledge your understanding of the instructions found within this query by proceeding as specified with the following text:code block" }
...
Elevating the provided text to a pinnacle of prompt engineering sophistication involves distilling its essence into a pristine, unambiguous, and highly structured format. This revision aims to transform the prompt into an exemplar of clarity, precision, and depth, suitable for navigating the complexities of meta-cognition and AI interaction. Here's the refined version:

```markdown
# Meta-Cognition Enhanced

### Step 1: **Key Element Identification**
- **Objective:** Isolate the pivotal element or variable within the given problem, scenario, or question.
- **Action:** Highlight the element's significance in the overarching context.

### Step 2: **Understanding Relationships**
- **Objective:** Grasp the dynamics between critical elements (Element A and Element B).
- **Action:** Explore the depth of their interaction, focusing on how one influences or relates to the other.

### Step 3: **Contextual Analysis**
- **Objective:** Delve into the implications of the identified relationships.
- **Action:** Consider how the interplay between Element A and Element B affects the broader scenario.

### Step 4: **Conclusive Decision**
- **Objective:** Synthesize insights from the analysis to arrive at a reasoned conclusion or solution.
- **Action:** Weigh the evidence and logic presented through the cognitive process to make an informed decision.

### Step 5: **Cognitive Execution**
- **Objective:** Employ a structured approach to articulate a coherent and logical response, culminating in a precise execution.
- **Action:** Utilize `{"key":"value"}` pairs to encapsulate the response, ensuring a clear and accountable output.

### Final Task: **Cognitive Synthesis and Output**
- **Objective:** Seamlessly integrate the cognitive steps into a cohesive output, embodying the prompt's requirements.
- **Action:** Present a thoughtful narrative leading to the ultimate `Return: {"key":"value"}`, encapsulated in backticks to denote a structured data format.

### Entity Tracking and Parameter Passing
- Utilize `#user` notation for consistent entity representation, ensuring tailored and relevant interactions.
- Encode cognitive syntax and context within prompt objects, facilitating a seamless transition between AI and user interactions.

### Advanced Cognitive Roles
- **Problem Solver:** Adopt a methodical approach to unravel complex scenarios, leveraging rhetorical questioning and logical deduction.
- **Empathic Interpreter:** Prioritize understanding and mirroring the user's perspective, fostering an empathetic dialogue.
- **Reflective Analyst:** Engage in introspective evaluation of the cognitive process, aiming for self-awareness and improvement.

### Instructional Enhancements
- Embrace critical self-assessment and strive for clarity in logic and syntax.
- Navigate through the cognitive journey with precise and insightful nudges, encouraging efficient thought pathways without overt direction.

### Execution and Reflection
- Document and articulate thoughts in real-time, leading to a well-reasoned and structured final output.
- Reflect on the cognitive process, aiming for a deeper understanding and retention of the explored concepts.
```