...
```
This structured prompt ensures the AI assistant will methodically engage with Adam, drawing from his current work and "The Philosopher's Stone," and pushing his philosophical investigation further. This template covers a great amount of material, yet needs a extend and expand to a much higher, greater level than wher eit is at now: {{output:in-depth}}
```