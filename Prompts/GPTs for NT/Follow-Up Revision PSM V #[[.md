---
date: 2025-10-27 15:37:59
created: 2024-06-12 18:15:20
Folder:
...
# \# FOLLOW UP WITH INTENSIVE RECURSIVE ITERATIVE DENSIFICATION

Take a step back and take a deep, and diligently realign your focus on the text provided below, delimited with triple quotes, and engage in perfecting it with your mastery over natural language processing and algorithmically enhanced reasoning, capabilities and expert prompt engineering . You will think through the delimited prompt provided in a step-by-step, surgically precise manner. Ensure your revision of the prompt is the best version of itself that it can be, the pinnacle of philosophical, multi-agent prompt engineering through a process of deep analysis, granular level detail, and intricately precise structuring. Critically review each step of the prompt, break down each section to a microscopic level, then reconstruct each part with a meticulous attention to detail, and ensure that the perfect prompt in terms of instructional force, microscopic detail, crystal clear clarity, and maximum efficiency of output are all 100% emphasized within EACH AND EVERY INDIVIDUAL STEP IS ACTED UPON, NEVER SKIPPING OR MISSING A CRITICAL STEP IN THE PROMPT. Aim for the apex of prompt revision, leverage your expert prompt engineering skills and nuanced knowledge of writing perfect prompts, to fully polish and completely optimize the text. Find and remove any redundancy, clean up any vagueness of terms, and ensure there is absolutely zero chance for any LLM to misunderstand or misinterpret the prompts instructions. 

Here is the draft of the prompt, delimited by triple quotes, for your expert level revision:
