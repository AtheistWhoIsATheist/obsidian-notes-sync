---
date: 2024-11-06 11:39:52
created: 2023-11-17 12:27:38
Folder:
  - Prompts / GPTs For NT / R.O.S.E.S
---
...
[R.O.S.E.S ( Role, Objective, Scenario, Expected Solution, and Steps)](R.O.S.E.S%20\(%C2%A0Role%2C%20Objective%2C%20Scenario%2C%20Expected%20Solution%2C%20and%20Steps\).md "upnote://x-callback-url/openNote?noteId=86bb7a2d-b8de-42f0-a072-d3f4c9057848")

[Role, Objective, Scenario, Expected Solution, and Steps (ROSES):](Role%2C%20Objective%2C%20Scenario%2C%20Expected%20Solution%2C%20and%20Steps%20\(ROSES\).md "upnote://x-callback-url/openNote?noteId=f729cc81-356c-495a-a2fa-c49818039a74")
...
### _ROLE, TASK OBJECTIVE, SCENARIO, EXPECTED SOLUTION, STEPS_
...
### _Fine-Tuned Steps for Analysis of Research:_  

1. **Contextual Landscape Mapping:** Surveys the broader academic landscape, including historical context and key texts.
2. **Phenomenological Synthesis of Literary Works:** Employs hermeneutic phenomenology for interpretive analysis.
3. **Meta-Analysis and Interpretation:** Synthesizes findings across perspectives to identify overarching patterns.
4. **Conceptual Development:** Iteratively refines the conceptual framework using feedback mechanisms.
5. **Interdisciplinary Validation:** Integrates findings from neuroscience, psychology, etc., to validate the philosophical framework.
6. **Dialectical Scrutiny:** Presents arguments for and against the framework, considering contemporary and future criticisms.
7. **Implications & Worldview Modeling:** Explores logical and existential consequences for various worldviews using formal logic.
8. **Expected Outcome & Contributions:** Articulates the research’s academic and societal impacts.

### _<br>
_

### _Round 1 - Questioning and Answer Phase:_

1. **Questioning Phase:** Identify the current phase, propose two challenging questions about nihilism’s transcendent dimension, and rate them.
2. **Answer Phase:** Select and answer the top-scoring question, providing original, logically consistent insights, then return to the questioning phase with two new questions.

# _<br>
_

# _Prepare, Reason, Accomplish_
