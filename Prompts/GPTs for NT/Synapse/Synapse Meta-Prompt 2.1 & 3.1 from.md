## Synapse Meta-Prompt 2.1 & 3.1 from
...
**J****un 10, 2024, 9:57 AM [#synapse](upnote://x-callback-url/tag/view?tag=synapse "#synapse")**

### [MOC Meta-Prompts](upnote://x-callback-url/openNote?noteId=d4c7cb1b-e5d5-45b5-a460-a2b55d7561ea)


[Philosophical Synergy Matrix (PSM) & Applied Expert System](upnote://x-callback-url/openNote?noteId=fe019fdc-e1ff-412b-862f-06c9db5b7fe0 "upnote://x-callback-url/openNote?noteId=fe019fdc-e1ff-412b-862f-06c9db5b7fe0")

[Philosophical Synergy Matrix (PSM)](upnote://x-callback-url/openNote?noteId=f42d3f66-d94b-47b2-ac23-d011db3c55de "upnote://x-callback-url/openNote?noteId=f42d3f66-d94b-47b2-ac23-d011db3c55de")


[Philosophical Synergy Matrix (PSM) & Applied Expert System](upnote://x-callback-url/openNote?noteId=5244596C-6858-4BB8-8559-DF0C3B474DFB "upnote://x-callback-url/openNote?noteId=5244596C-6858-4BB8-8559-DF0C3B474DFB")


[Philosophical Synergy Matrix (PSM) & Applied Expert System 'Follow-Up' Prompt Aiming for a Perfect Revision](upnote://x-callback-url/openNote?noteId=AEEA0DC9-5F99-45BF-ABD7-F8D06A075F72 "upnote://x-callback-url/openNote?noteId=AEEA0DC9-5F99-45BF-ABD7-F8D06A075F72")

---

# Synapse Meta-Prompt [#PSM](upnote://x-callback-url/tag/view?tag=PSM "#PSM")
...
**Step 6**: Iterative Socratic Dialogue and Deepening Analysis Repeat the exploration and reflection process for each idea. 
...
**Iterative Densification Cycling**: Always follow up on searches. Circle back and repeat the entire process "N" number of times, until topic is exhausted. The process is cyclical, not linear, always linking back to any thought from previous phases. 
...
This revised response incorporates all necessary context and provides a clear, structured approach to explaining each capability, ensuring that the reader can fully grasp the depth and breadth of the described capabilities.