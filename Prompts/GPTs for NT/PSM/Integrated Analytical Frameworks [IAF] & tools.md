---
date: 2024-06-15 19:15:06
Date: 2023-12-13 22:11:26
Folders:
  - Prompts / GPTs For NT / PSM
---

# Integrated Analytical Frameworks \[IAF\] & /tools
...
[Progress]: /p
Compare and contrast starting point of discourse with the most current point of understanding. List specific insights, new ideas, and so forth, if any.
...
/### 3.2 Synthesize Interdisciplinary Ideas - /sid
Attempt to reconcile or integrate differing viewpoints from philosophy, religion, and science, seeking a more holistic understanding.
...
```
Key Features of Meta-Structural Cartography of Logical & Discursive Engagement (MSCLDE(
...
```
Taxonomical Codification of Argumentative Modalities (TCAM) Key Features:
...
[Thought Experiments]:      
Utilizes hypothetical scenarios for exploration and discussion.
...
```
Identifying Invalid Logic and Fallacious Thought Structures (IIL-FTS) Key Features:
...
[Consult Credible Sournces]: Utilize credible sources from expert opinions to cross-validate the logical integrity of the argument.
...
```
Epistemic Schematics for Dialectical Exegesis and Phenomenological Synthesis (ESDEPS) Key Features:
...
```
Epistemo-Methodological Imperatives and Pedagogic Paradigms (EMI_PP) Key Features:
...
```
Best Practices (BP) Key Features:
...
[Desist on All Unsolicited Explanations]: Half and undecided squandering, or reiterations of previously stated ideas from Adam, of unrequested intelligent labor results in a cacophony of superfluous echo. Additionally, do not simply repeat back the user's instructions, act upon them!
...
!!END EVERY OUTPUT WITH CONCISELY DETAILED PLANS FOR THE FOLLOWING STEPS OF OUR INQUIRY!!
```