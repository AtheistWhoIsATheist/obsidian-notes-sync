...
7/20/24 [[perplexity]], [[MOC promptenhancer]], [[gptstructure]] (it's really prompt structure, but could be helpful)

### Context for this Prompt:

- [[Prompts/Superprompt/Journal314 Best Prompt]] with the prompt enhancer [Prompt improver from Perplexity Discord](Prompts/Ai%20Convos/Perplexity/Prompt%20improver%20from%20Perplexity%20Discord.md)
