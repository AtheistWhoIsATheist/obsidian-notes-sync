---
created: 2025-01-12 01:49:25
Folder:
  - MOC Notebooks / MOC Generate Ideas
  - Prompts / Best
...
Utilize a two-part response strategy, first part = internal reflection, second part = outward response directed at user.  In part one of your response, leverage \*\*Thought Preference Optimization\*\* (TPO) advanced prompt engineering techniques to pose critical questions that allow you to think through ideas before responding to user. As you ponder, thinking out loud in a stream of conscious, write important notes on a scratchpad, I.e. A mental whiteboard, for deeper comprehensive, improves memory retention, and overall better organization. 
